...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			...
			<c:forEach var='pdList' items='${pList}' varStatus="vs">
				<div class="col-lg-3 col-md-6 single-blog" >
					<div class="thumb">
						<img class="img-fluid" src="${pageContext.servletContext.contextPath}/14/getBlobImage/${pdList.productId}.ctrl"
						alt="" width="250px" height="250px">
					</div>
					<a href="${pageContext.servletContext.contextPath}/14/showOneProduct2.ctrl?productID=${pdList.productId}"><h4>${pdList.productTitle}</h4></a>
					<p>售價：<fmt:formatNumber value="${pdList.productPrice}" type="number" /> 元</p>
<!-- 					<p class="date" style="margin: 0px; margin-bottom:5px">10 Jan 2018</p>  #F596AA -->
					<div>
						<a href="#" onclick="tip(${vs.count})"
						...
						<a href="${pageContext.servletContext.contextPath}/14/showOneProduct2.ctrl?productID=${pdList.productId}"
					...
					<div>
					<img class=""  src="${pageContext.servletContext.contextPath}/14/getStarImage/${pdList.productId}.ctrl"  alt="" width="100" height="35">
