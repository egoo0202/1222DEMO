	...
	<section class="blog-area " id="blog" style="background-color: #ffff"
		...
		<div class="container" id="app">
			...
			<div class="row">
				...
				<input type="hidden" id="${vs.count}productId" value="${pdList.productId}"/>
				<input type="hidden" id="${vs.count}productTitle" value="${pdList.productTitle}"/>
				<input type="hidden" id="${vs.count}productPrice" value="${pdList.productPrice}"/>
				<input type="hidden" id="${vs.count}productNum" value="${pdList.productNum}"/>
